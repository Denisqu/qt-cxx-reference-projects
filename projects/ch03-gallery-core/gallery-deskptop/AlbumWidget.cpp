  ...
  , mPictureSelectionModel(nullptr)
{
  ...
  connect(ui->thumbnailListView,
          &QListView::doubleClicked,
          this,
          &AlbumWidget::pictureActivated);

  connect(ui->addPicturesButton,
          &QPushButton::clicked,
          this,
          &AlbumWidget::addPictures);

  connect(
    ui->deleteButton, &QPushButton::clicked, this, &AlbumWidget::deleteAlbum);
...
void
AlbumWidget::setAlbumSelectionModel(QItemSelectionModel* albumSelectionModel)
{
...
void
AlbumWidget::setPictureModel(ThumbnailProxyModel* pictureModel)
{
...
void
AlbumWidget::setPictureSelectionModel(QItemSelectionModel* selectionModel)
{
...
AlbumWidget::editAlbum()
{
  ...
  if (ok && !newName.isEmpty())
    mAlbumModel->setData(
      currentAlbumIndex, newName, AlbumModel::Roles::NameRole);
}
...
AlbumWidget::addPictures()
{
  ...
  if (!filenames.isEmpty()) {
    auto lastModelIndex = QModelIndex();
...
void
AlbumWidget::loadAlbum(const QModelIndex& albumIndex)
{
